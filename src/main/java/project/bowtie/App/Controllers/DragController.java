...
public class DragController {
    ...
    // Initialize the DragController with a target Node and a boolean to determine if the Node is draggable
    ...
    // Create the event handlers for dragging the Node
    ...
    // Create the BooleanProperty for the isDraggable property
